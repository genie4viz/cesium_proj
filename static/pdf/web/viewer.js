...
var PDFViewerApplication = {
  ...
  zoomIn: function zoomIn(ticks) {
    ...
    do {
      newScale = (newScale * DEFAULT_SCALE_DELTA).toFixed(4);
  ...
  setInitialView: function setInitialView(storedHash) {
    ...
    var setRotation = function setRotation(angle) {
      if ((0, _ui_utils.isValidRotation)(angle)) {
        _this6.pdfViewer.pagesRotation = 0;//angle
      }
    };
...
function webViewerInitialized() {
  ...
  //file='http://47.104.174.116:8081/typhoon/gtlxpg/±800锦苏线/20/687.pdf';
...
var defaultOptions = {
  ...
  defaultUrl: {
    value: 'http://59.110.116.23:8080/xianService/687.pdf',
    kind: OptionKind.VIEWER
  },
  defaultZoomValue: {
    value: '',
