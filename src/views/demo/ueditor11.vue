...
<div id="11111111111111"  >
    ...
    <script :id="ueId" class="ueditor-box" type="text/plain" style="width: 90%; height: 200px;margin-top:0px;">请输入：</script>

    <!-- 获取内容 -->

    <p><el-button    style="float:right;margin-right:20%;padding-top:2px;pading-left:2px;width: 120px;text-align:center; height: 20px; border-width: 0px; border-radius: 4px; background: rgb(50,120,178); cursor: pointer; outline: 1px; font-family: Microsoft YaHei; color: white; font-size: 13px; box-shadow: 0 1px 2px #1E90FF inset,0 -1px 0 #a8abae inset;"  @click="getContent()">提交审核信息</el-button></p>
    <el-dialog
      title="内容"
